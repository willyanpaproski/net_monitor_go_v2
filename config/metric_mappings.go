...
var VendorMetricMappings = map[string][]MetricConfig{
	"mikrotik": {
		...
		},
		{
			...
			Interval:     5 * time.Second,
			DataKey:      "temperature",
			FallbackKeys: []string{"temperature"},
			Required:     true,
		},
	},
	"think": {
	...
	"tplinkp7000": {
		...
		},
		{
			...
			Interval:     5 * time.Second,
			DataKey:      "used_memory_mb",
			FallbackKeys: []string{"memory", "mem_used_percent", "memory_used_percent"},
			Required:     true,
		},
		{
			Name:         "temperature",
		...
		// 	Name:         "ponInterfaces",
		// 	Interval:     30 * time.Second,
		// 	DataKey:      "ponInterfaces",
		// 	FallbackKeys: []string{"ponInterfaces"},
		// 	Required:     false,
		// },
		{
			Name:         "onuInfo",
